...
<div class="col-md-4 col-md-offset-4" ng-controller="ctlLogin">
  <h2>Entrar</h2>
  <form name="formLogin">
    <div class="form-group" ng-class="{ 'has-error': formLogin.username.$dirty && formLogin.username.$error.required }">
      <input type="text" name="username" class="form-control" placeholder="Email" ng-model="login.username" required>
    </div>
